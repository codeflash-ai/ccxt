...
class Exchange(object):
    ...
    def safe_integer(dictionary, key, default_value=None):
        """
        Optimized hot-path implementation for faster integer retrieval from dicts/lists.
        """
        try:
    ...
    def safe_number(self, obj, key: IndexType, defaultNumber: Num = None):
        """
        Optimized hot-path: avoids safe_string call to minimize overhead.
        """
        try:
            value = None
