...
class Exchange(object):
    ...
    def parse_precision(self, precision: str):
        ...
        if precisionNumber == 0:
            return "1"
        if precisionNumber > 0:
            # Use string multiplication for zeros, avoids loop
            return "0." + ("0" * (precisionNumber - 1)) + "1"
        else:
            # For negative or large precisions, minimize loop
            return "1" + ("0" * ((-precisionNumber) - 1)) + "0"
