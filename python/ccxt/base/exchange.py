...
class Exchange(object):
    ...
    def safe_string(dictionary, key, default_value=None):
        # Fast path: Use .get for dict type, else fall back
    ...
    def safe_string_2(dictionary, key1, key2, default_value=None):
        # Fast path: Prefer .get if dict
        if isinstance(dictionary, dict):
            v1 = dictionary.get(key1, None)
            if v1 is not None and v1 != "":
                return str(v1)
            v2 = dictionary.get(key2, None)
    ...
    def iso8601(timestamp=None):
        # Fastest check order and minimal overhead
        ...
        try:
            ...
            # Extract first 3 digits of microsecond part
            return s + "{:03d}".format(ms) + "Z"
