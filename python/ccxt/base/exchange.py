...
class Exchange(object):
    ...
    def safe_string(dictionary, key, default_value=None):
        key_exists = Exchange.key_exists
    ...
    def safe_value_2(dictionary, key1, key2, default_value=None):
        # Inline the logic to avoid one extra indirection of function call
        key_exists = Exchange.key_exists
        if key_exists(dictionary, key1):
            return dictionary[key1]
        elif key_exists(dictionary, key2):
    ...
    def safe_balance(self, balance: dict):
        ...
        for code in codes:
            entry = balance[code]
            total = safe_string(entry, "total")
            free = safe_string(entry, "free")
            used = safe_string(entry, "used")
            debt = safe_string(entry, "debt")
