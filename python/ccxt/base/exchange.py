...
class Exchange(object):
    ...
    def safe_string(dictionary, key, default_value=None):
        # Performance optimization: Fast lookup for dict, fallback for other mappings or sequences
        # This covers usual use case for dict and preserves original behavioral correctness
        ...
        # Fallback for other sequences/mappings
        return (
            str(dictionary[key])
            if Exchange.key_exists(dictionary, key)
            else default_value
    ...
    def safe_number(self, obj, key: IndexType, defaultNumber: Num = None):
        # Inline fast safe_string logic to avoid repeated call overhead
        ...
        value = str(obj[key]) if Exchange.key_exists(obj, key) else None
