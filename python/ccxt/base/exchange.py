...
class Exchange(object):
    ...
    def safe_integer(dictionary, key, default_value=None):
        # Fast path for dicts (common case in ccxt), skip function call overhead and unnecessary lookups
        try:
            value = dictionary[key]
        ...
        try:
            ...
            # shortcuts for int values & str-int
    ...
    def safe_number(self, obj, key: IndexType, defaultNumber: Num = None):
        # Inline the default safe_string to avoid extra function call
        try:
            value = obj[key]
        except (KeyError, TypeError):
            value = None
        if value is None:
            return self.parse_number(None, defaultNumber)
