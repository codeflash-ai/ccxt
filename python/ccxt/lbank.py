...
class lbank(Exchange, ImplicitAPI):
    ...
    def parse_transaction_status(self, status, type):
        # Use the preconstructed class-level mapping
        return self.safe_string(self.safe_value(_LBANK_TRANSACTION_STATUSES, type, {}), status, status)
